...
@section('content')
    <div class="max-w-2xl mx-auto py-8">
        <h2 class="text-2xl font-bold text-gray-800 mb-6">Nueva Planta</h2>
        ...
        <form action="{{ route('admin.plants.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
            ...
            <div>
                ...
                <input type="text" name="binomial_name" id="binomial_name" value="{{ old('binomial_name') }}"
                    class="w-full px-4 py-2 rounded border">
            </div>
            ...
            <div>
                <label class="block font-semibold" for="image">Imagen (JPG)</label>
            ...
            <div>
                ...
                <input type="number" name="waterings_per_week" id="waterings_per_week"
                    value="{{ old('waterings_per_week') }}" class="w-full px-4 py-2 rounded border">
            </div>
            ...
            <div>
                ...
                <select name="fertilizer_type" id="fertilizer_type" class="w-full px-4 py-2 rounded border">
                    ...
                    <option value="nitrogen" {{ old('fertilizer_type') === 'nitrogen' ? 'selected' : '' }}>Nitrogenado
                    </option>
                    <option value="phosphorus" {{ old('fertilizer_type') === 'phosphorus' ? 'selected' : '' }}>Fosforado
                    </option>
                </select>
            </div>
            ...
            <div>
                ...
                <input type="number" name="height_in_cm" id="height_in_cm" value="{{ old('height_in_cm') }}"
                    class="w-full px-4 py-2 rounded border">
            </div>
